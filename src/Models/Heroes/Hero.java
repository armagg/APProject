...
public class Hero {
    ...
    public Hero(String name, int HP, boolean isEquipped, Amulet equipAmulet, Inventory inventory, ArrayList<Amulet> amulets, ArrayList<Item> items, HashMap<String, Integer> numberOfHeroThings) {
        this.name = name;
        this.HP = HP;
